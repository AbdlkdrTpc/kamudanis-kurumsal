...
Son Güncelleme: 11 Aralık 2025 Versiyon: 2.1

📋 Hızlı Özet
🔐 Şifreleme	Apple CloudKit standart şifreleme
...
Veri Türü	Örnek	Zorunlu	Amaç
👤 Görünecek İsim	Ahmet Y.	✅ Evet	Profil oluşturma, toplulukta görünme
🏛️ Kurum Türü	Belediye, Bakanlık, vb.	✅ Evet	Topluluk oluşturma
🏢 Kurum Adı	Pendik Belediyesi	✅ Evet	Doğrulama, profil
📂 Birim	İhale Müdürlüğü	✅ Evet	Uzmanlık alanı belirleme
💼 Unvan	İhale Uzmanı	✅ Evet	Güvenilirlik gösterimi
📍 Şehir	İstanbul	✅ Evet	Yerel içerik sağlama
⚠️ Not: Gerçek ad-soyad ve e-posta adresi zorunlu değildir. Görünecek isim olarak takma ad kullanabilir, Apple Hide My Email özelliğiyle e-postanızı gizleyebilirsiniz.
...
⚡ Anında Aktivasyon	Hesabınız hemen aktif olur, onay beklemenize gerek yok
...
Amaç	Detay	Yasal Dayanak
🔑 Hesap Yönetimi	Kullanıcı hesaplarının oluşturulması ve doğrulanması	Sözleşme
🎯 Hizmet Sağlama	Soru-cevap platformunun işletilmesi	Sözleşme
👮 Moderasyon	İçeriklerin onaylanması, uygunsuz içeriklerin kaldırılması	Meşru menfaat
⭐ Karma Sistemi	Katkıların puanlanması ve seviyelerin belirlenmesi	Sözleşme
🛡️ Güvenlik	Spam önleme, kötüye kullanım engelleme	Meşru menfaat
📈 İyileştirme	Uygulama deneyiminin geliştirilmesi	Meşru menfaat
...
🔐 Şifreleme	Apple standart şifreleme (at-rest & in-transit)
...
Taraf	Amaç	Yasal Dayanak
🍎 Apple Inc.	iCloud/CloudKit veri depolama	Sözleşme
⚖️ Yetkili Makamlar	Yasal zorunluluk (mahkeme kararı)	Yasal yükümlülük
✅ Sizin Onayınız	Açık rızanız varsa	Açık rıza
...
✅ Görünecek isminiz (takma ad olabilir)
✅ Unvanınız
✅ Kurum türü ve adı
...
1️⃣ Bilgi Edinme	Verilerinizin işlenip işlenmediğini öğrenme	E-posta ile başvuru
2️⃣ Erişim	İşlenen verilerinize erişim talep etme	Profil > Ayarlar veya e-posta
3️⃣ Düzeltme	Yanlış verilerin düzeltilmesini isteme	Profil > Düzenle
4️⃣ Silme	Verilerinizin silinmesini talep etme	Profil > Ayarlar > Hesabımı Sil
5️⃣ Aktarım Bilgisi	Verilerin aktarıldığı kişileri öğrenme	E-posta ile başvuru
6️⃣ İtiraz	Otomatik sistemlere itiraz etme	E-posta ile itiraz
7️⃣ Tazminat	Kanuna aykırı işlemden zarar görürseniz tazminat	Yasal başvuru
...
📱 Uygulama İçi Bildirim gönderilir
🗓️ Son Güncelleme tarihi değiştirilir
✅ Önemli değişiklikler için onayınız alınır
...
Veri Sorumlusu
Abdulkadir TOPCU Pendik/İstanbul, Türkiye E-posta: 
kdrtpc@icloud.com
...
Kimlik	Görünecek isim (takma ad olabilir)
...
Zaman	Kayıt tarihi, son aktivite
⚠️ Not: E-posta adresi yalnızca Apple ile Giriş sırasında isteğe bağlı olarak paylaşılabilir. Hide My Email özelliğiyle gizlenebilir.

Kişisel Verilerin İşlenme Amaçları
Üyelik işlemlerinin gerçekleştirilmesi
Soru-cevap hizmetinin sunulması
Kullanıcı kimliğinin doğrulanması
Topluluk moderasyonu
Hesap güvenliğinin sağlanması
Spam ve kötüye kullanımın önlenmesi
Karma sisteminin işletilmesi
...
Görünecek isminiz veya kullanıcı adınız
Başvuru konusu
Talep detayları
