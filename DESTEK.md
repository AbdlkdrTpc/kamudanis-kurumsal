...
> **Merhaba!** KamuDanış ailesinin bir parçası olduğunuz için teşekkür ederiz. Size nasıl yardımcı olabiliriz?
...
2. **🔍 Keşfedin**
   ...
   - İlgi alanınıza göre filtreleyin
   - Arama özelliğinden yararlanın

3. **💬 Katılın**
   - İlk sorunuzu sorun
   - Bildiğiniz konularda cevap verin
   - Karma puanı kazanın
...
3. "Şikayet Et" seçeneğini seçin
4. Şikayet nedeninizi belirtin
5. Gönder
...
| Durum | Süre |
|-------|------|
| 3 reddedilen soru (1 saat içinde) | 24 saat |
| Spam içerik | 7 gün |
| Hakaret / Küfür | 30 gün |
| Gizli bilgi paylaşımı | Kalıcı |
| Kimlik taklidi | Kalıcı |
...
Her türlü soru, öneri ve şikayetleriniz için:

📧 **kdrtpc@icloud.com**

📅 **Yanıt Süresi:** En geç 3 iş günü içinde

---

### 🐛 Hata Bildirimi

Teknik sorun yaşıyorsanız, e-postanızda şunları belirtin:

- 📱 Cihaz modeli ve iOS sürümü
...
1. Öneriyi kdrtpc@icloud.com adresine gönderin
2. Özelliği detaylı açıklayın
3. Neden yararlı olacağını belirtin
4. Benzer uygulamalardaki örnekleri paylaşın

🎉 **İyi öneriler değerlendirilir ve gelecek versiyonlara eklenebilir!**
...
KamuDanış'ı tercih ettiğiniz için teşekkür ederiz. Birlikte daha güçlüyüz! 💙
